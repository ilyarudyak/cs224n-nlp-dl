...
class NERModel(Model):
    ...
    def fit(self, sess, saver, train_examples_raw, dev_set_raw):
        ...
        for epoch in range(self.config.n_epochs):
            ...
            # The general idea is to loop over minibatches from train_examples, and run train_on_batch
            # inside the loop
            ...
            for inputs_minibatch in minibatches(train_examples, self.config.batch_size):
                self.train_on_batch(sess, *inputs_minibatch)
            ### END YOUR CODE
